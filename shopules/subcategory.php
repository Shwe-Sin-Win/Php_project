...
$sql="SELECT subcategories.*,categories.name as cname FROM subcategories JOIN categories ON subcategories.category_id=categories.id WHERE subcategories.id=:id";
...
$cid=$subcategories['category_id'];
$cname=$subcategories['cname'];
