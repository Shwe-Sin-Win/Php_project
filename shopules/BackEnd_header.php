...
<html lang="en">
    ...
    <body class="app sidebar-mini">
        ...
        <aside class="app-sidebar">
            ...
            ?>
            <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="<?= $_SESSION['loginuser']['profile'] ?>" alt="User Image" width="70" height="70">
                <div>
                  <p class="app-sidebar__user-name"><?= $_SESSION['loginuser']['name'] ?></p>
                  <p class="app-sidebar__user-designation"><?= $_SESSION['loginuser']['rname'] ?></p>
                </div>
            </div>
        ...
        <?php endif; ?>
            ...
            <ul class="app-menu">
                ...
                <li>
                    <a class="app-menu__item" href="userlist.php">
                ...
                <li>
                    <a class="app-menu__item" href="brandlist.php">
                ...
                <li>
                    <a class="app-menu__item" href="itemlist.php">
                ...
                <li>
                    <a class="app-menu__item" href="subcategorylist.php">
                ...
                <li>
                    <a class="app-menu__item" href="categorylist.php">
